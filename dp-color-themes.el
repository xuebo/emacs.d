(provide 'dp-color-themes)

(defun color-theme-xuebo-black-white ()
...
;	 term-default-bg "black")
  (color-theme-install
   ...
   (gnus-emphasis-bold ((t (:bold t :foreground "dark violet"))))
   ...
   (gnus-emphasis-underline ((t (:underline t :foreground "dark violet"))))
   (gnus-emphasis-underline-bold ((t (:underline t :bold t))))
   (gnus-emphasis-underline-bold-italic ((t (:underline t :italic t :bold t :foreground "dark violet"))))
